...
#ifndef LIBUSB0_DIR
#define LIBUSB0_DIR "D:/Android/workspace/windows-usb/libusb-win32-bin-1.2.6.0/libusb-win32-bin-1.2.6.0"
#endif

/* embed libusbK driver files from the following location */
#ifndef LIBUSBK_DIR
#define LIBUSBK_DIR "D:/Android/workspace/windows-usb/libusbK/libusbK-3.0.7.0-bin/bin"
#endif
